...
struct action_replay_stateful_object_t_state_t { action_replay_args_t args; };

static action_replay_stateful_return_t
action_replay_stateful_object_t_state_t_new( action_replay_args_t const args )
{
...
static action_replay_return_t action_replay_stateful_object_t_state_t_delete(
...
)
{
    ...
    if( 0 == result.status ) { free( stateful_object_state ); }
    return result;
}

action_replay_class_t const * action_replay_stateful_object_t_class( void );

static action_replay_return_t action_replay_stateful_object_t_internal(
...
static inline action_replay_return_t action_replay_stateful_object_t_copier(
